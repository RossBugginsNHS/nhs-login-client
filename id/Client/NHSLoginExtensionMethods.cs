...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class NHSLoginExtensionMethods
    {
        public static WebApplicationBuilder AddNHSLogin(this WebApplicationBuilder builder )
        {
            ...
            {
             //   options.DefaultSignOutScheme= IdentityServerConstants.ExternalCookieAuthenticationScheme;
          //      options.DefaultScheme = IdentityServerConstants.ExternalCookieAuthenticationScheme;//CookieAuthenticationDefaults.AuthenticationScheme;
